...
pub fn style_for_highlight(index: usize) -> Style {
    match index {
        ...
        1 => Style::default()
            .fg(Color::Rgb(0x5C, 0x63, 0x70))
            .add_modifier(Modifier::ITALIC), // comment
        2 => Style::default().fg(Color::Rgb(0xD1, 0x9A, 0x66)), // constant   → orange
        3 => Style::default()
            .fg(Color::Rgb(0xD1, 0x9A, 0x66))
            .add_modifier(Modifier::BOLD), // constant.builtin
        ...
        7 => Style::default()
            ...
            .add_modifier(Modifier::BOLD), // function.builtin
        ...
        20 => Style::default()
            ...
            .add_modifier(Modifier::BOLD), // type.builtin
        21 => Style::default().fg(Color::Rgb(0xAB, 0xB2, 0xBF)), // variable
        22 => Style::default()
            .fg(Color::Rgb(0xD1, 0x9A, 0x66))
            .add_modifier(Modifier::ITALIC), // variable.builtin
        23 => Style::default()
            .fg(Color::Rgb(0xE0, 0x6C, 0x75))
            .add_modifier(Modifier::ITALIC), // variable.parameter

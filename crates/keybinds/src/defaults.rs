...
pub fn default_normal_map() -> KeyMap {
    ...
    // Word movement
    m.insert(
        KeyBinding::plain(KeyCode::Char('w')),
    ...
    // Mode switches
    m.insert(
        KeyBinding::plain(KeyCode::Char('i')),
        Action::EnterInsertMode,
    );
    m.insert(
        KeyBinding::plain(KeyCode::Char('a')),
    ...
    m.insert(
        KeyBinding::plain(KeyCode::Char('o')),
    ...
    m.insert(
        KeyBinding::plain(KeyCode::Char('v')),
    ...
    m.insert(
        KeyBinding::plain(KeyCode::Char('C')),
